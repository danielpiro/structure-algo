...
export const WallDesigner: React.FC = () => {
  ...
  const [selectedLayerDetails, setSelectedLayerDetails] = useState<item | null>(
    null
  );
  ...
  useEffect(() => {
    if (selectedLayer) {
      const details = getItem(
        selectedLayer.material,
        selectedLayer.manufacturer,
                ...
                {selectedLayer && selectedLayerDetails && (
                  <div className="mt-4 p-4 bg-gray-100 rounded-md">
                    ...
                    <p>
                      ...
                      {selectedLayerDetails.material}
                    </p>
                    <p>
                      <span className="font-medium">Manufacturer:</span>{" "}
                      {selectedLayerDetails.manufacturer}
                    </p>
                    <p>
                      <span className="font-medium">Product:</span>{" "}
                      {selectedLayerDetails.product}
                    </p>
                    <p>
                      <span className="font-medium">Thickness:</span>{" "}
                      {selectedLayer.thickness.toFixed(3)} cm
                    </p>
                    <p>
                      <span className="font-medium">Thermal Conductivity:</span>{" "}
                      {selectedLayerDetails.thermalConductivity.toFixed(3)}{" "}
                      W/(m·K)
                    </p>
                    <p>
                      <span className="font-medium">Mass:</span>{" "}
                      {selectedLayerDetails.specificMass} kg/m³
                    </p>
                    <p>
